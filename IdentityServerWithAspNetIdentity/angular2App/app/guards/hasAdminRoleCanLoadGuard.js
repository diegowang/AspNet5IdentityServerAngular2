...
export var HasAdminRoleCanLoadGuard = (function () {
    function HasAdminRoleCanLoadGuard(securityService) {
        this.securityService = securityService;
    }
    HasAdminRoleCanLoadGuard.prototype.canLoad = function (route) {
        console.log('excuting canLoad!');
        return this.securityService.HasUserAdminRole && this.securityService.IsAuthorized;
    };
    HasAdminRoleCanLoadGuard = __decorate([
        Injectable(), 
