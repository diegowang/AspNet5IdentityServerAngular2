...
export var UserManagementService = (function () {
    function UserManagementService(_http, _configuration, _securityService) {
        var _this = this;
        this._http = _http;
    ...
    UserManagementService.prototype.setHeaders = function () {
